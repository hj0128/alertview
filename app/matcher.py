...
CATEGORY_KEYWORDS = {
    ...
    "뷰티": ["뷰티", "미용실", "미용", "헤어", "염색", "네일", "피부", "에스테틱", "스킨", "살롱",
           ...
           "아로마", "피부관리", "눈썹", "여드름", "모공", "리프팅", "보톡스", "필러", "레이저",
           "점빼기", "슈가링", "젤네일", "페디큐어", "스킨케어", "피부케어", "두피케어", "헤어케어",
           "퍼스널컬러", "문신", "타투", "각질", "필링", "여드름케어"],
    ...
    "배송": ["배송", "택배", "제품", "식품", "집으로"],
    # 바른 '배달'은 '배달불가/배달X/포장 or 배달' 같은 부정·부수 표현까지 잡아 오분류 →
    # 배달앱(배민·요기요 등) 또는 '[배달]'·'배달체험' 처럼 명시된 경우만 배달로 본다.
